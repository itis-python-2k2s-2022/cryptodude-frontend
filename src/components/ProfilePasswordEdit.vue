    ...
    <b-card-body>
      ...
      <b-form @submit="onSubmitP" @reset="onResetP" v-if="show">
        <b-form-group
          ...
          <b-form-input id="input-old-password" type="password" v-model="form.old_password"/>
        ...
        <b-form-group
          ...
          <b-form-input id="input-new-password" :state="newPasswordState" type="password" v-model="form.new_password"/>
          <b-form-invalid-feedback
              class="color-custom-yellow"
        ...
        <b-form-group
          ...
          <b-form-input id="repeat-new-password" :state="passwordRepeatState" type="password" v-model="form.repeat_password"/>
          <b-form-invalid-feedback
              class="color-custom-yellow"
...
export default {
  ...
  computed: {
    ...
    formIsValid() {
      return (
          this.newPasswordState && this.passwordRepeatState
      );
    },
  },
  methods: {
    async onSubmitP(event) {
      ...
      if (this.formIsValid) {
        try {
          const response = await request.post('/users/me/change_password', this.form);
